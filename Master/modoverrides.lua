return {
  ...
  ["workshop-347079953"]={
    configuration_options={ DFV_Language="RU", DFV_MinimalMode="default" },
    enabled=true 
  },
  ...
  ["workshop-503919639"]={ configuration_options={ FIX_EQUIP_NOISE=true }, enabled=true },
  ["workshop-755028761"]={ configuration_options={ Charcoal=5, Cutstones=5, Goldnugget=5 }, enabled=true },
  ["workshop-758532836"]={
    configuration_options={
